...
`heta init` exige uma chave de API de um LLM. A análise de PDF e Office pode usar o MinerU opcionalmente: https://mineru.net/apiManage/docs.

## Core Concepts

- **Wiki foundation**: a wiki funciona como camada base de conhecimento; arquivos originais viram páginas Markdown estáveis com identificadores numéricos.
